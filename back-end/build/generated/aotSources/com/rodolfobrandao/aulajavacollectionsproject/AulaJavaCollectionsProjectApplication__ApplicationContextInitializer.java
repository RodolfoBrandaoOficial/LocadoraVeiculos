 ...
 */
@Generated
public class AulaJavaCollectionsProjectApplication__ApplicationContextInitializer implements ApplicationContextInitializer<GenericApplicationContext> {
  @Override
  public void initialize(GenericApplicationContext applicationContext) {
    ...
    new AulaJavaCollectionsProjectApplication__BeanFactoryRegistrations().registerBeanDefinitions(beanFactory);
    new AulaJavaCollectionsProjectApplication__BeanFactoryRegistrations().registerAliases(beanFactory);
  }
  ...
  private void addImportAwareBeanPostProcessors(DefaultListableBeanFactory beanFactory) {
    ...
    mappings.put("org.springframework.security.config.annotation.web.configuration.WebSecurityConfiguration", "com.rodolfobrandao.aulajavacollectionsproject.config.auth.SecurityConfiguration");
