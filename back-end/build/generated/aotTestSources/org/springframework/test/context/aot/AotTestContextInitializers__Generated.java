...
import com.rodolfobrandao.aulajavacollectionsproject.controllers.MountCtlTest__TestContext001_ApplicationContextInitializer;
...
public class AotTestContextInitializers__Generated {
  public static Map<String, Supplier<ApplicationContextInitializer<? extends ConfigurableApplicationContext>>> getContextInitializers(
    ...
    map.put("com.rodolfobrandao.aulajavacollectionsproject.controllers.MountCtlTest", () -> new MountCtlTest__TestContext001_ApplicationContextInitializer());
    return map;
  }
  ...
  public static Map<String, Class<? extends ApplicationContextInitializer<?>>> getContextInitializerClasses(
    ...
    map.put("com.rodolfobrandao.aulajavacollectionsproject.controllers.MountCtlTest", MountCtlTest__TestContext001_ApplicationContextInitializer.class);
    return map;
  }
}
